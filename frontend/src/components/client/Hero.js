...
function Hero() {
  return (
    <div className="mt-24 flex flex-col justify-center items-center max-w-screen-xl mx-auto">
      <img src={CoverLogo} alt="Cover Pronto Logo" className="h-40 mt-6 select-none" />
